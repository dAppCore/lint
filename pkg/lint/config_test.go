...
func TestConfig_DefaultConfig_Good(t *core.T) {
	...
	core.AssertContains(t, cfg.Lint.Go, "golangci-lint")
...
func TestConfig_DefaultConfig_Bad(t *core.T) {
	...
	fresh := DefaultConfig()
	core.AssertEqual(t, "golangci-lint", fresh.Lint.Go[0])
...
func TestConfig_ResolveConfigPath_Good(t *core.T) {
	...
	core.AssertEqual(t, core.CleanPath(filepath.Join(projectPath, ".core", "lint.yaml"), "/"), ResolveConfigPath(projectPath, ""))
	core.AssertEqual(
		t,
...
func TestConfig_LoadProjectConfig_Good(t *core.T) {
	...
	core.RequireNoError(t, os.WriteFile(filepath.Join(dir, ".core", "lint.yaml"), []byte(`output: sarif
fail_on: warning
paths:
  - src
exclude:
...
`), 0o644))
	...
	core.RequireNoError(t, err)
	core.AssertEqual(t, filepath.Join(dir, ".core", "lint.yaml"), path)
	...
	core.AssertEqual(t, "golangci-lint", cfg.Lint.Go[0])
}
