...
const (
	ax7TestAlphaTxtcbf40a       = "alpha.txt"
	ax7TestBadPath3a3d4d        = "bad\x00path"
	ax7TestEmptyTxtd8884f       = "empty.txt"
	ax7TestMissingTxt5f0d60     = "missing.txt"
	ax7TestNestedAlphaTxt8eb38f = "nested/alpha.txt"
	ax7TestNewTxtd6f7e0         = "new.txt"
	ax7TestOldTxt12e59c         = "old.txt"
)
...
func TestIO_NewSandboxed_Good(t *T) {
	...
	AssertFalse(t, medium.Exists(ax7TestMissingTxt5f0d60))
}
...
func TestIO_Medium_Read_Good(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestAlphaTxtcbf40a, "alpha"))
	got, err := medium.Read(ax7TestAlphaTxtcbf40a)
	AssertNoError(t, err)
...
func TestIO_Medium_Read_Bad(t *T) {
	medium := ax7Medium(t)
	got, err := medium.Read(ax7TestMissingTxt5f0d60)
	AssertError(t, err)
	AssertEqual(t, "", got)
}
...
func TestIO_Medium_Read_Ugly(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestEmptyTxtd8884f, ""))
	got, err := medium.Read(ax7TestEmptyTxtd8884f)
	AssertNoError(t, err)
	AssertEqual(t, "", got)
}
...
func TestIO_Medium_Write_Good(t *T) {
	medium := ax7Medium(t)
	err := medium.Write(ax7TestNestedAlphaTxt8eb38f, "alpha")
	AssertNoError(t, err)
	AssertTrue(t, medium.IsFile(ax7TestNestedAlphaTxt8eb38f))
}

func TestIO_Medium_Write_Bad(t *T) {
	medium := ax7Medium(t)
	err := medium.Write(ax7TestBadPath3a3d4d, "alpha")
	AssertError(t, err)
	AssertNotNil(t, medium)
}
...
func TestIO_Medium_Write_Ugly(t *T) {
	medium := ax7Medium(t)
	err := medium.Write(ax7TestEmptyTxtd8884f, "")
	AssertNoError(t, err)
	AssertTrue(t, medium.IsFile(ax7TestEmptyTxtd8884f))
}
...
func TestIO_Medium_WriteMode_Bad(t *T) {
	medium := ax7Medium(t)
	err := medium.WriteMode(ax7TestBadPath3a3d4d, "alpha", 0o600)
	AssertError(t, err)
	AssertNotNil(t, medium)
}
...
func TestIO_Medium_IsFile_Good(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestAlphaTxtcbf40a, "alpha"))
	got := medium.IsFile(ax7TestAlphaTxtcbf40a)
	AssertTrue(t, got)
	AssertTrue(t, medium.Exists(ax7TestAlphaTxtcbf40a))
}

func TestIO_Medium_IsFile_Bad(t *T) {
	medium := ax7Medium(t)
	got := medium.IsFile(ax7TestMissingTxt5f0d60)
	AssertFalse(t, got)
	AssertFalse(t, medium.Exists(ax7TestMissingTxt5f0d60))
}
...
func TestIO_Medium_Delete_Good(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestAlphaTxtcbf40a, "alpha"))
	err := medium.Delete(ax7TestAlphaTxtcbf40a)
	AssertNoError(t, err)
	AssertFalse(t, medium.Exists(ax7TestAlphaTxtcbf40a))
}

func TestIO_Medium_Delete_Bad(t *T) {
	medium := ax7Medium(t)
	err := medium.Delete(ax7TestMissingTxt5f0d60)
	AssertError(t, err)
	AssertFalse(t, medium.Exists(ax7TestMissingTxt5f0d60))
}
...
func TestIO_Medium_Delete_Ugly(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestNestedAlphaTxt8eb38f, "alpha"))
	err := medium.Delete(ax7TestNestedAlphaTxt8eb38f)
	AssertNoError(t, err)
...
func TestIO_Medium_Rename_Good(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestOldTxt12e59c, "alpha"))
	err := medium.Rename(ax7TestOldTxt12e59c, ax7TestNewTxtd6f7e0)
	AssertNoError(t, err)
	AssertTrue(t, medium.IsFile(ax7TestNewTxtd6f7e0))
}

func TestIO_Medium_Rename_Bad(t *T) {
	medium := ax7Medium(t)
	err := medium.Rename(ax7TestMissingTxt5f0d60, ax7TestNewTxtd6f7e0)
	AssertError(t, err)
	AssertFalse(t, medium.Exists(ax7TestNewTxtd6f7e0))
}

func TestIO_Medium_Rename_Ugly(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestOldTxt12e59c, "alpha"))
	RequireNoError(t, medium.Write(ax7TestNewTxtd6f7e0, "beta"))
	err := medium.Rename(ax7TestOldTxt12e59c, ax7TestNewTxtd6f7e0)
	AssertNoError(t, err)
}
...
func TestIO_Medium_Stat_Good(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestAlphaTxtcbf40a, "alpha"))
	info, err := medium.Stat(ax7TestAlphaTxtcbf40a)
	AssertNoError(t, err)
	AssertEqual(t, ax7TestAlphaTxtcbf40a, info.Name())
}

func TestIO_Medium_Stat_Bad(t *T) {
	medium := ax7Medium(t)
	info, err := medium.Stat(ax7TestMissingTxt5f0d60)
	AssertError(t, err)
	AssertNil(t, info)
}
...
func TestIO_Medium_Open_Good(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestAlphaTxtcbf40a, "alpha"))
	file, err := medium.Open(ax7TestAlphaTxtcbf40a)
	AssertNoError(t, err)
	AssertNotNil(t, file)
	ax7Close(t, file)
}
...
func TestIO_Medium_Open_Bad(t *T) {
	medium := ax7Medium(t)
	file, err := medium.Open(ax7TestMissingTxt5f0d60)
	AssertError(t, err)
	AssertNil(t, file)
}
...
func TestIO_Medium_Create_Bad(t *T) {
	medium := ax7Medium(t)
	writer, err := medium.Create(ax7TestBadPath3a3d4d)
	AssertError(t, err)
	AssertNil(t, writer)
}
...
func TestIO_Medium_Append_Bad(t *T) {
	medium := ax7Medium(t)
	writer, err := medium.Append(ax7TestBadPath3a3d4d)
	AssertError(t, err)
	AssertNil(t, writer)
}
...
func TestIO_Medium_ReadStream_Good(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestAlphaTxtcbf40a, "alpha"))
	reader, err := medium.ReadStream(ax7TestAlphaTxtcbf40a)
	AssertNoError(t, err)
...
func TestIO_Medium_ReadStream_Bad(t *T) {
	medium := ax7Medium(t)
	reader, err := medium.ReadStream(ax7TestMissingTxt5f0d60)
	AssertError(t, err)
	AssertNil(t, reader)
}
...
func TestIO_Medium_ReadStream_Ugly(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestEmptyTxtd8884f, ""))
	reader, err := medium.ReadStream(ax7TestEmptyTxtd8884f)
	AssertNoError(t, err)
	data, readErr := stdio.ReadAll(reader)
	AssertNoError(t, readErr)
	ax7Close(t, reader)
...
func TestIO_Medium_WriteStream_Bad(t *T) {
	medium := ax7Medium(t)
	writer, err := medium.WriteStream(ax7TestBadPath3a3d4d)
	AssertError(t, err)
	AssertNil(t, writer)
}
...
func TestIO_Medium_Exists_Good(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestAlphaTxtcbf40a, "alpha"))
	got := medium.Exists(ax7TestAlphaTxtcbf40a)
	AssertTrue(t, got)
	AssertTrue(t, medium.IsFile(ax7TestAlphaTxtcbf40a))
}

func TestIO_Medium_Exists_Bad(t *T) {
	medium := ax7Medium(t)
	got := medium.Exists(ax7TestMissingTxt5f0d60)
	AssertFalse(t, got)
	AssertFalse(t, medium.IsFile(ax7TestMissingTxt5f0d60))
}
...
func TestIO_Medium_IsDir_Bad(t *T) {
	medium := ax7Medium(t)
	RequireNoError(t, medium.Write(ax7TestAlphaTxtcbf40a, "alpha"))
	got := medium.IsDir(ax7TestAlphaTxtcbf40a)
	AssertFalse(t, got)
	AssertTrue(t, medium.IsFile(ax7TestAlphaTxtcbf40a))
}
