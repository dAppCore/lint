...
// Medium is the filesystem abstraction consumed by lint and core/scm.
...
// Local exposes the host filesystem without the broken upstream syscall path.
var Local Medium = localMedium{root: string(filepath.Separator)}

// NewSandboxed returns a medium rooted under the supplied directory.
